# ============================================================
# PROJECT 4 - Python Comments & Syntax (ULTIMATE EXPANDED + BONUS)
# ============================================================
# Level: Beginner (Lessons 01 + 02 + 03 + 04)
# Topics: Introduction, Setup, print(), Comments, Indentation
#
# INSTRUCTIONS:
...
# EXTRA 7: Call the fixed function
say_hello()

# EXTRA 8: Semicolon usage (multiple statements on one line)
print("First"); print("Second"); print("Third")

# ============================================================
# END OF PROJECT 4 - ULTIMATE EXPANDED EDITION (sub6)
# ============================================================