...
#  1 - It is used in everything: web, games, apps, AI
#  2 - It is easy to download, install and use
#  3 - It has a large community that helps you
...
#  It is a text editor used for writing code for programming
#  languages, and it has many tools to support code writers,
#  like highlighting the code and finding errors.
#
#  Examples of IDEs/editors:
#  1 - VS Code
#  2 - PyCharm
#
...
#  and all new libraries work with it.)
...
#  and build real websites that people use.)
